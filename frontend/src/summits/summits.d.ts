...
*/
export function run(width: number, token_address: string, html_canvas_id: string): void;
...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5c7f051fc6ef4cd5: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h394405d4ded23a3f: (a: number, b: number, c: number) => void;
