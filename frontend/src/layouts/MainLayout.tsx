...
export default function MainLayout({ children }: LayoutProps) {
  ...
  // TODO: Make the title in the top left not have an underline.
  const body = (
        ...
        <Flex alignItems="center" gap="2">
          <Flex alignItems="center" gap="2" flex="1">
            <Box>
              <ChakraLink
                as={ReactRouterLink}
                to={`/?network=${globalState.network}`}
              >
                <Heading size="md">Aptos Summits</Heading>
              </ChakraLink>
            </Box>
            <Box marginLeft={2}>
              <a href="https://github.com/banool/aptos-summits">
                <IconButton
                  size="xs"
                  fontSize="sm"
                  variant="ghost"
